...
<div id="wrapper">
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li><a href="news.php" accesskey="3" title="">News e Iniziative</a></li>
				<li><a href="aiuto.html" accesskey="4" title="">Come Aiutarci</a></li>
				<li><a href="guide.html" accesskey="5" title="">Giude Antiviolenza</a></li>
  ...
  <div id="page" class="container">
		<div class="title">
            <h2>Scrivi ad AIDA: garantiamo riservatezza e anonimato!</h2>
           <!-- www.123formbuilder.com script begins here --><script type="text/javascript" defer src="//www.123formbuilder.com/embed/5043179.js" data-role="form" data-default-width="650px"></script><!-- www.123formbuilder.com script ends here -->
		   <ul class="actions">
				<li><a href="index.html" class="button">Torna alla Homepage</a></li>
			</ul>
        </div>
	</div>
</div>
